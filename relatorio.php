        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header">
                <h3 style= "margin-left:39%; font-size: 30px"class="card-title">Relatório de Contatos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editar.php?idUp=<?php echo $show-> id_contato;?>" title="Editar" type="submit" class="btn btn-success">
                    <img style="width: 15px;" src="img/svg/aaa.png"></a>
                    <a href= "deletar.php?idDel=<?php echo $show-> id_contato;?>" onclick="return confirm('Tem certeza que você deseja remover o contato?')" title="Remover" type="submit" class="btn btn-danger">
                    <img style="width: 15px;" src="img/svg/path2.png"></a>
                    </td>
                  </tr>
                  <?php
                      }
